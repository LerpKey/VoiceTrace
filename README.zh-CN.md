...
具体的模型准备、API Key 配置和审阅流程见[录音审阅工作台使用手册](docs/reference/audio-review-user-guide.zh-CN.md)。
...
- [录音审阅工作台使用手册](docs/reference/audio-review-user-guide.zh-CN.md) · [English](docs/reference/audio-review-user-guide.md)
- [模型打包与安装约定](docs/model-packaging.zh-CN.md) · [English](docs/model-packaging.md)
